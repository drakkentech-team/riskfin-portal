<template>
  ...
  <div style="max-width: 90%; margin: 0 10%;">
    <h1 style="margin-top: 2rem; margin-bottom: 10px; color: #262626; text-align: center;"> Child Details</h1>
    <form @submit.prevent="nextPage" action="./first-extended-details" method="POST">
      <fieldset>
            ...
            <div class="col-lg-6">
              ...
              <div class="row">
                <div class="col-lg-8 d-flex align-items-center" style="margin-top: 0.5rem;">
                  ...
                  <!-- <div class="col-lg-8"> -->
                  <!-- <input type="hidden" id="BirthDate" class="form-control" name="BirthDate" value="" required>
            ...
            <div class="col-lg-6 float-right" style="margin-top: -16.2rem;">
              ...
              <div class="row" style="padding-right: 10%;padding-left: 5%;">
                ...
                <div class="col-lg-12">
                  ...
                  <input type="button" style="background-color: #90162a;color: white;" id="btnSkipChild"
                    name="btnSkipChild" class="btn btn-default" value="Skip" @click="skip">
...
export default {
  computed: {
    ...mapGetters(['getUserData', 'getSpouseData']),
    ...mapActions(['addChild']),
  },
  data() {
    return {
  ...
  methods: {
    ...
    async nextPage() {
      ...
      //   first_name: "Zoe",
      //   surname: "Smith",
      //   type_of_identity_document: "Birth Certificate",
      //   id: "4653423223221",
      //   date_of_birth: "2010-02-15",
      //   age: "13",
      //   type_of_child: "Daughter",
      ...
      // Now you can use the 'data' object as needed in your JavaScript code.
      ...
      try {
        const response = await axios.post('http://localhost:9000/riskfin_direct_family_children', childrenData, {
          headers: {
        ...
        if (response.status === 201) {
          ...
          console.log('Child data saved successfully:', response.data);
          this.$router.push('./first-extended-details');
        } else {
          // Handle errors or show error messages to the user
          console.error('Failed to save child data:', response.data);
        }
      } catch (error) {
        console.error('Error while saving child data:', error);
      }
    },
    skip() {
      this.$router.push('./first-extended-details');
