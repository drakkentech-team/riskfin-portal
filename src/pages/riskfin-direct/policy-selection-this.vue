<template>
    <div class="container">
        <section class="content">
            ...
            <span v-if="validationError && !selectedPolicy" style="margin-left: 40%; color: #a5223a; font-size: small;">You
                must select a Policy to
                continue!</span>
            <div style="margin: 1rem 0 1rem 40rem; display: flex;">
                <p style="color: #90162a; font-size: 18px; text-align: center;">
                    Select one of the above mentioned options</p>
