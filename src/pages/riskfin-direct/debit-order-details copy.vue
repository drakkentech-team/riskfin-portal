          ...
          <div class="col-lg-6">
            ...
            <div class="row align-items-center">
              <div class="col-lg-8 d-flex align-items-center" style="margin-top: 0.5rem;">
                ...
                <input tabindex="1" type="text" id="AccountHolder" class="form-control" name="AccountHolder"
                  v-model="storedData.FirstName">
              ...
              <div class="col-lg-8 d-flex align-items-center" style="margin-top: 0.5rem;">
                <div class="col-lg-4" style="padding-right: 5rem;">
                  <label for="Type of Identity Document">BankName </label>
                </div>
                ...
                <div style=" padding-left: 10px; margin-left: -10px; color: red;float: inline-start; font-size: 20px;"
              ...
              <div class="col-lg-8 d-flex align-items-center" style="margin-top: 0.5rem;">
                <div class="col-lg-4" style="padding-right: 4rem;">
                  <label for="Type of Identity Document">BranchName </label>
                </div>
                <select class="form-control" id="TOD" name="TOD">
                  <option value="-1">Select One</option>
                ...
                <div style=" padding-left: 0; margin-left: -30px; color: red;float: inline-start; font-size: 20px;"
                  id="star" class="star" name="star"><b>*</b></div>
                <div style="clear: both;"></div>
                <p class="text-danger"> </p>
                <p class=".bg-danger">
              ...
              <div class="col-lg-8 d-flex align-items-center" style="margin-top: 0.5rem;">
                ...
                <input type="text" id="BranchCode" class="form-control" name="BranchCode" v-model="storedData.ID">
            ...
            <div class="col-lg-8 d-flex align-items-center" style="margin-top: 0.5rem;">
              ...
              <input type="text" id="AccountNo" class="form-control" name="AccountNo" v-model="storedData.ID">
              <div style=" padding-left: 10px; margin-left: 5px; color: red;float: inline-start; font-size: 20px;"
                class="star" id="star" name="star"><b>*</b></div>
              <div style="clear: both;"></div>
              <p class="text-danger"> </p>
              ...
              <div class="checkbox">
                <label><input type="checkbox" name="singON" checked="" value="singON">
                  <p> I, <strong><span style="color: black;" id="AccHInitials">N</span> <span style="color: black;"
                    ...
                    <strong>
                      <span style="color: black;" id="DedDay">1</span></strong>.
