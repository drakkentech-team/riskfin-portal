<template>
  <div>
    ...
    <div style=" margin-bottom: 8rem; margin-left: 35%;">
      <p>First Names </p>
  ...
  methods: {
    ...
    async sendEmailAndGoToThankYou() {
      ...
      this.$router.push({
        ...
        query: userData,
        query: {
          firstNames: this.storedData.firstNames,
          email: this.storedData.firstNames,
          contactPhoneNumber: this.storedData.firstNames,
          surname: this.storedData.firstNames,
        },
      });
