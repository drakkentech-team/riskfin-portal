...
const handleSaveProduct = async () => {
  ...
  try {
    ...
    const response = await axios.post('http://127.0.0.1:9000/policy_details', {
...
const showUpdateDialog = (item) => {
  ...
  form.policy_name = item.policy_name;
  form.short_description = item.short_description;
  form.long_description = item.long_description;
  form.policy_premium = item.policy_premium;
  form.premium_due_date = item.premium_due_date;
